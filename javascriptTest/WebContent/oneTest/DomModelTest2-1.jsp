...
// 	var borderList = {'black','red','orange','green','purple','hotpink'};
	...
	var myClassList = document.getElementsByClassName("myChoiceTag2")
		...
		myClassList[0].style.border = '1px solid black';
		myClassList[1].style.border = '1px solid red';
		myClassList[2].style.border = '1px solid orange';
		myClassList[3].style.border = '1px solid green';
		myClassList[4].style.border = '1px solid purple';
		myClassList[5].style.border = '1px solid hotpink';
