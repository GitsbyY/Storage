...
<body>
	...
	<div id='resultAvgTag' style="border: 1px solid green;">
		평균: ???(소수점 2자리 까지) 
	</div>
...
// 함수
	...
	function threeSumFnc(){
		...
		var resultSumTagObj = document.getElementById('resultSumTag');
...
// 		var thirdNum = Number(thirdNumObj.value);
		...
		var sumResultNum = threeSumFnc();
		var avgResultNum = sumResultNum/3;
		var floorNum = Math.floor((avgResultNum) * 100) / 100
		var resultAvgTagObj = document.getElementById('resultAvgTag');
