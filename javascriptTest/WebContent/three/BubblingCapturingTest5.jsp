...
// 		다 true면 부모순으로 출력
		...
		var aTagObj = document.getElementById('parentDiva');
		aTagObj.setAttribute('href', "https://www.google.com/");
		aTagObj.addEventListener('click', parentDivaFunc);
		
		var aTagObj2 = document.getElementById('parentDiv2a');
		aTagObj2.addEventListener('click', parentDiv2aFunc);
	...
	function parentDivaFunc() {
		
		event.stopPropagation();
// 		event.preventDefault();
	}
	function parentDiv2aFunc() {
		alert('네이버 점검 중.');
		event.stopPropagation();
		event.preventDefault();
	}
...
<body>
	...
	<div id='rootDiv' title="난 최상위 Div야">
		...
		<div id='parentDiv' title='난 첫번째 부모DIv야'>
			<a id='parentDiva' >나 클릭하면 구글 페이지가 뜸</a>
		</div>
		
		parentDiv2
		<div id='parentDiv2' title="난 두번째 부모 Div야">
			<a id='parentDiv2a' href="https://www.naver.com/">
