...
//		사원번호와 사원명을 표시하시오.
		...
		if (choiceEmp != null) {
			...
			System.out.println("사원번호: " + empMap.get(inputEmpNo).getEmpNo()); //사원번호 표시
			System.out.println("사원명: " + empMap.get(inputEmpNo).getEmpName()); //사원명 표시
...
//		입사한 사원의 정보를 입력하는 로직을 구현하시오.
//		새 사원은 블라디미르 사원인데 번호는 순차적으로 부여하고 급여는 2000원으로 적용하시오.
		employee = new Employee("4", "블라디미르", 2000);
		empMap.put(employee.getEmpNo(), employee);
		
//		새로 입사했다는 표현을 통해 표현하고
		System.out.println("새로운 사원이 입사했습니다.");
