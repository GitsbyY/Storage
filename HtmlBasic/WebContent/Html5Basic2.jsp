...
<body>
	...
	<form>
		<fieldset>
		  ...
		  <p>
		  	<label for="number">수량 : </label><input type="number" min="1" max="10" step="2" value="1" id="number" />
		  </p>
		  <p>
		  	<label for="range">만족도 : </label><input type="range" min="1" max="10" step="2" value="1" id="range" />
		  </p>
		  <p>
