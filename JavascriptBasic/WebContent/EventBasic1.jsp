...
<head>
	<meta charset="UTF-8">
	<title>EventBasic1</title>
</head>

<body>
	
	<img alt="음" src="./images/img1.jpg" onclick="eventFnc();">
...
// 	각 태그들은 상.하위 구조나 병렬구조 등으로 체계화 되는데
// 	이렇게 정리 된 체계를 DOM이라고 부른다
	
// 	이들이 각 태그와의 상호작용을 가능하게 해 주면 웹 페이지가 보다
// 	인터렉티브하게 작동하게 된다
