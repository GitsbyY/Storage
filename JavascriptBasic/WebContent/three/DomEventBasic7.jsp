...
// 	브라우저 창에 포함 된 모든 객체 태그들을 의미한다
	
// 	브라우저라는 것도 결국 창(window)안에서 실행되는 프로그램이기에
...
// 		screen		스크린(monitor)에 대한 정보를 제공하는 객체
// 		history		인터넷 방문 기록에 대한 정보를 제공하는 객체(가능하면 사용 금지)
	var myAgent=navigator.userAgent.toLowerCase();
	var mobile=["iphone","ipod","android","blackberry"
			,"window ce","nokia","webos","opera mini"
