...
<body>
	...
	<div id='weekClac'>
		<img alt="일" src="./week/sun.jpg">
		<img alt="월" src="./week/mon.jpg">
		<img alt="화" src="./week/tue.jpg">
		<img alt="수" src="./week/wen.jpg">
		<img alt="목" src="./week/thur.jpg">
		<img alt="금" src="./week/fri.jpg">
		<img alt="토" src="./week/sat.jpg">
	</div>
...
// 		document.write("<img src=" + divList[randNum].src + ">");
		...
		document.getElementsByTagName('img')[0].setAttribute('style', 'width: 200px; height: 200px');
