...
/*
		...
		일종의 추상 클래스이다
		인터페이스는 추상 메서드를 갖지만 추상 클래스보다 추상화 정도가 높아서 추상 클래스와 달리
		...
		단, static 메서드와 디폴트 메서드는 예외(jdk1.8이후로 가능해짐)
		...
		인터페이스를 구현하는 클래스가 작성 될 때까지 기다리지 않고도 양쪽에서 동시에 개발을
		진행 할 수 있다
		
		2. 표준화가 가능하다
		프로젝트의 기본 틀을 제공함으로서 보다 일관되고 정형화된 프로그램이 가능하다
